			...
			<div class="col-md-4">
				...
				<table class="table table-striped table-bordered table-condensed">
					...
					<tbody>
						...
						<tr>
								<td>Paid</td>
								<td><fmt:formatNumber type="currency" value="${invoice['PAID AMOUNT']}" /></td>
								<td><fmt:formatNumber type="number" pattern="###" value="${invoice['PAID']}" /></td>
							</tr>
							<tr>
								<td>Pending</td>
								<td><fmt:formatNumber type="currency" value="${invoice['PENDING AMOUNT']}" /></td>
								<td><fmt:formatNumber type="number" pattern="###" value="${invoice['PENDING']}" /></td>
							</tr>
					</tbody>
				</table>	
			</div>
